        ...
        <div className="my-presets__wrapper">
          ...
          <div className="my-presets__info">
            ...
            <p className="my-presets__info-text">
              Вы можете создавать наборы из любимых продуктов. Это позволит вам
              быстрее добавить товары в корзину. А также мы добавили возможность
              полной автоматизации заказа! Для этого вам необходимо:
            </p>
            ...
            <p className="my-presets__info-text">
              При необходимости вы сможете выключить “автозаказ” или изменить
              его настройти в любой момент
            </p>
          </div>
        </div>
      </div>
